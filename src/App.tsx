        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 section-rounded shadow-xl hidden md:block">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              <div className="relative inline-block">
                <div className="rounded-[40px] border-8 border-white/10 shadow-2xl max-w-[300px] mx-auto overflow-hidden bg-black">
                  <video 
                    autoPlay 
                    muted 
                    loop 
                    ...
                    className="w-full h-full object-cover"
                  >
                    <source src="https://skzfezsseuyqgzbdapng.supabase.co/storage/v1/object/public/meeeeee/grok-video-927c5327-ec2c-4886-af05-f14b3a8bd2c4.mp4" type="video/mp4" />
                  </video>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                img: "https://skzfezsseuyqgzbdapng.supabase.co/storage/v1/object/public/meeeeee/WhatsApp%20Image%202026-03-07%20at%207.23.42%20PM%20(1).jpeg"
              }
            ].map((modelo, i) => (
